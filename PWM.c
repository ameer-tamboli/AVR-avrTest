...
void InitPWM()
{
   ...
   BIT 6 : WGM00  Wave form generartion mode [SET to 1]//Fast PWM
   BIT 5 : COM01  Compare Output Mode        [SET to 1]//Toggle on compare match non inverting
   ...
   */
   ...
   //Set OC0 PIN as output. It is  PB4 on ATmega128
